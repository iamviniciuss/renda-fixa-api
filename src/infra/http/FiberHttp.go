...
func (f *FiberHttp) Get(path string, callback func(map[string]string, []byte, QueryParams) (interface{}, error)) {
...
func (f *FiberHttp) Post(path string, callback func(map[string]string, []byte, QueryParams) (interface{}, error)) {
